...
<?php 
wp_enqueue_style( 'thankyou', untrailingslashit( plugins_url( '/', __FILE__ ) ) . '/css/thankyou.css');
$mahacod_orderid = get_post_meta( $order->id, '_maha_tracking_code');
if (isset($mahacod_orderid) && !empty($mahacod_orderid[0])){
	echo '<div class="orderid_box"><div style="text-align:center">کد رهگیری : <strong>'.$mahacod_orderid[0].'</strong></div><span>با استفاده از این کد میتوانید وضعیت سفارش خود را پیگیری کنید</span></div>';
}
?>
